(() => {
    ...
    da.init();
    document.querySelectorAll(".answers__input").forEach((input => {
        input.addEventListener("change", (event => {
            document.querySelectorAll(".answers__text").forEach((text => {
                text.classList.remove("active");
            }));
            if (event.target.checked) event.target.parentNode.parentNode.querySelector(".answers__text").classList.add("active");
        }));
    }));
    window["FLS"] = true;
    isWebp();
